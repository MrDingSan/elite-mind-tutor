...
import { FaGraduationCap, FaBook, FaChartLine, FaUsers, FaAward, FaLaptop, FaCheckCircle, FaArrowRight, FaGlobe, FaVideo, FaClock, FaMapMarkerAlt, FaHeadset } from 'react-icons/fa';
