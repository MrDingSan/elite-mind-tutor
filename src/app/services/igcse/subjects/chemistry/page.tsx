        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-indigo-100">
              Expert guidance for Cambridge IGCSE Chemistry
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 py-16">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span>Fundamental principles of chemistry</span>
                </li>
                <li className="flex items-start">
                  <FaFlask className="h-6 w-6 text-indigo-600 mr-2 flex-shrink-0" />
                  <span>Essential laboratory skills and safety</span>
                </li>
                <li className="flex items-start">
                  <FaFlask className="h-6 w-6 text-indigo-600 mr-2 flex-shrink-0" />
                  <span>Preparation for Core examination papers</span>
                </li>
              </ul>
            </div>
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  <FaFlask className="h-6 w-6 text-indigo-600 mr-2 flex-shrink-0" />
                  <span>Advanced chemical concepts and applications</span>
                </li>
                <li className="flex items-start">
                  <FaFlask className="h-6 w-6 text-indigo-600 mr-2 flex-shrink-0" />
                  <span>Extended laboratory work and analysis</span>
                </li>
                <li className="flex items-start">
                  <FaFlask className="h-6 w-6 text-indigo-600 mr-2 flex-shrink-0" />
                  <span>Preparation for Extended examination papers</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <ul className="space-y-2">
                ...
                <li>Stoichiometry</li>
                <li>Electricity and Chemistry</li>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <ul className="space-y-2">
                ...
                <li>Chemical Energetics (Extended)</li>
                <li>Chemical Reactions (Extended)</li>
                <li>Acids, Bases and Salts (Extended)</li>
                <li>The Periodic Table (Extended)</li>
                <li>Metals (Extended)</li>
                <li>Air and Water (Extended)</li>
                <li>Sulfur (Extended)</li>
                <li>Carbonates (Extended)</li>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-lg p-8 text-center">
              ...
              <p className="text-gray-600">
                Average improvement of 2-3 grades in final scores
              </p>
            </div>
            <div className="bg-white rounded-xl shadow-lg p-8 text-center">
        ...
        <div className="text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Join our community of successful IGCSE Chemistry students and get the support you need to achieve your goals.
          </p>
          <a
            href="/request-tutor"
