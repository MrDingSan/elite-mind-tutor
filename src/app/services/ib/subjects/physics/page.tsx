...
export default function IBPhysics() {
  return (
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-indigo-100">
              Expert guidance for IB Physics at both SL and HL levels
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span>Core concepts in mechanics, waves, and energy</span>
                </li>
                <li className="flex items-start">
                  <FaAtom className="h-6 w-6 text-indigo-600 mr-2 flex-shrink-0" />
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  <FaAtom className="h-6 w-6 text-indigo-600 mr-2 flex-shrink-0" />
                  <span>Advanced topics in quantum physics and relativity</span>
                </li>
                <li className="flex items-start">
                  <FaAtom className="h-6 w-6 text-indigo-600 mr-2 flex-shrink-0" />
                ...
                <li className="flex items-start">
                  <FaAtom className="h-6 w-6 text-indigo-600 mr-2 flex-shrink-0" />
                  <span>Preparation for university-level physics</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <ul className="space-y-2">
                ...
                <li>Quantum and Nuclear Physics</li>
                <li>Option Topics (Astrophysics, Engineering Physics, etc.)</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 mb-4">
            Ready to Excel in IB Physics?
          </h2>
          <p className="text-lg text-gray-600 mb-8">
            Join our community of successful IB Physics students and get the support you need to achieve your goals.
          </p>
          <a
            href="/request-tutor"
